...
public class SubCategoryServicesAdapter$SearchServiceViewHolder_ViewBinding implements Unbinder {
  private SubCategoryServicesAdapter.SearchServiceViewHolder target;

  @UiThread
  public SubCategoryServicesAdapter$SearchServiceViewHolder_ViewBinding(
      SubCategoryServicesAdapter.SearchServiceViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SubCategoryServicesAdapter.SearchServiceViewHolder target = this.target;
