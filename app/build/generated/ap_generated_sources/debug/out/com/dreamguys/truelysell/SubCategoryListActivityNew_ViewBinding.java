...
public class SubCategoryListActivityNew_ViewBinding extends BaseActivity_ViewBinding {
  ...
  @UiThread
  public SubCategoryListActivityNew_ViewBinding(SubCategoryListActivityNew target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public SubCategoryListActivityNew_ViewBinding(SubCategoryListActivityNew target, View source) {
    super(target, source);
  ...
  @Override
  public void unbind() {
    SubCategoryListActivityNew target = this.target;
