...
public class HomeNewServicesAdapter$CategoryViewHolder_ViewBinding implements Unbinder {
  private HomeNewServicesAdapter.CategoryViewHolder target;

  @UiThread
  public HomeNewServicesAdapter$CategoryViewHolder_ViewBinding(
      HomeNewServicesAdapter.CategoryViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    HomeNewServicesAdapter.CategoryViewHolder target = this.target;
