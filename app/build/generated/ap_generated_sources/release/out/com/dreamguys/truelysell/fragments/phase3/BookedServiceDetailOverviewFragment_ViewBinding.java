...
public class BookedServiceDetailOverviewFragment_ViewBinding implements Unbinder {
  private BookedServiceDetailOverviewFragment target;

  @UiThread
  public BookedServiceDetailOverviewFragment_ViewBinding(BookedServiceDetailOverviewFragment target,
      View source) {
    this.target = target;
    ...
    target.llProvDescDetail = Utils.findRequiredViewAsType(source, R.id.ll_prov_desc_detail, "field 'llProvDescDetail'", LinearLayout.class);
    target.description = Utils.findRequiredViewAsType(source, R.id.description, "field 'description'", TextView.class);
    target.serviceOffered = Utils.findRequiredViewAsType(source, R.id.serviceOffered, "field 'serviceOffered'", TextView.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    BookedServiceDetailOverviewFragment target = this.target;
    ...
    target.llProvDescDetail = null;
    target.description = null;
    target.serviceOffered = null;
  }
}
