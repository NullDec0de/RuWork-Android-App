...
public class ViewAllPopularAdapter$SearchServiceViewHolder_ViewBinding implements Unbinder {
  private ViewAllPopularAdapter.SearchServiceViewHolder target;

  @UiThread
  public ViewAllPopularAdapter$SearchServiceViewHolder_ViewBinding(
      ViewAllPopularAdapter.SearchServiceViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ViewAllPopularAdapter.SearchServiceViewHolder target = this.target;
