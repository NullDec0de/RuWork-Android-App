...
//        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_YES);
        ...
        iv_Mapactivity = findViewById(R.id.iv_mapactivity);
    ...
    private void getDateandtime() {
        if (AppUtils.isNetworkAvailable(this)) {
            ...
            try {
                ...
                RetrofitHandler.executeRetrofit(this, classificationCall, AppConstants.GETDATETIME,
                        this, false);
            } catch (Exception e) {
    ...
    public void showUserLoginDialog() {
        ...
        otpView.setOtpCompletionListener(new OnOtpCompletionListener() {
            ...
            public void onOtpCompleted(String otp) {
                ...
                BaseActivity.this.postUserLogin(etMobileNumber.getText().toString(), ccp.getSelectedCountryCode().toString(), otp);
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view1) {
                if (otpView.getText().toString().isEmpty() || otpView.getText().toString().length() < 4) {
                    ...
                    InputMethodManager imm = (InputMethodManager) BaseActivity.this.getSystemService(INPUT_METHOD_SERVICE);
                    imm.hideSoftInputFromWindow(otpView.getWindowToken(), 0);
                    BaseActivity.this.postUserLogin(etMobileNumber.getText().toString(), ccp.getSelectedCountryCode().toString(), otpView.getText().toString());
                }
            }
        });
            ...
            public void onClick(View view13) {
                if (cbExistingUser.isChecked()) {
                    if (ccp.getSelectedCountryCode().toString().isEmpty()) {
                        ...
                        BaseActivity.this.getMobileOtp(ccp.getSelectedCountryCode().toString().trim(),
...
//                    Toast.makeText(this, GETDateandTime1.toString(), Toast.LENGTH_SHORT).show();
