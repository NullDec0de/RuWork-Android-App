...
public class ViewAllServicesActivity extends BaseActivity implements TabLayout.OnTabSelectedListener, RetrofitHandler.RetrofitResHandler {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_Mapactivity = (ImageView) findViewById(R.id.iv_mapactivity);
        iv_Mapactivity.setVisibility(View.VISIBLE);
        ...
        } else if (getIntent().getStringExtra(AppConstants.VIEWALLTYPE).equalsIgnoreCase("3")){
            viewpagerServices.setCurrentItem(2);
            setToolBarTitle(AppUtils.cleanLangStr(this,
                    viewAllStringsList.getLbl_newly_added_service().getName(), R.string.newly_added_services));
        } else {
            viewpagerServices.setCurrentItem(1);
            setToolBarTitle(AppUtils.cleanLangStr(this,
                    "Featured Services", R.string.txt_featured_services));
        }

        iv_Mapactivity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if(viewpagerServices.getCurrentItem()==0){
                    Intent callMapActivity = new Intent(ViewAllServicesActivity.this, GetAJobMapViewActivity.class);
                    callMapActivity.putExtra("page", "viewallservices");
                    callMapActivity.putExtra("type", "Popular");
                    callMapActivity.putExtra("value", "");
                    startActivity(callMapActivity);
                } else if(viewpagerServices.getCurrentItem()==1){
                    Intent callMapActivity = new Intent(ViewAllServicesActivity.this, GetAJobMapViewActivity.class);
                    callMapActivity.putExtra("page", "viewallservices");
                    callMapActivity.putExtra("type", "Feature");
                    callMapActivity.putExtra("value", "");
                    startActivity(callMapActivity);
                } else {
                    Intent callMapActivity = new Intent(ViewAllServicesActivity.this, GetAJobMapViewActivity.class);
                    callMapActivity.putExtra("page", "viewallservices");
                    callMapActivity.putExtra("type", "New");
                    callMapActivity.putExtra("value", "");
                    startActivity(callMapActivity);
                }
