    ...
    public void onSuccess(Object myRes, boolean isLoadMore, String responseType) {
        switch (responseType) {
            case AppConstants.MYREQUESTS:
                ...
                if (daoMyRequests.getData() != null && daoMyRequests.getData().getList().size() > 0) {
                    rvMyservices.setVisibility(View.VISIBLE);
                    tvNoRecordsFound.setVisibility(View.GONE);
                    linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
                    rvMyservices.setLayoutManager(linearLayoutManager);
                    rvMyservices.setAdapter(new MyRequestsAdapter(this, MyBookingRequestsActivity.this, daoMyRequests.getData().getList()));
                } else {
