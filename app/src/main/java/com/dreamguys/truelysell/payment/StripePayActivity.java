...
//        setToolBarTitle(getString(R.string.hint_subscription));
    ...
    private void getTransactionId(String id) {
        ...
        RetrofitHandler.executeRetrofit(StripePayActivity.this, subscriptionSuccessModelCall,
                AppConstants.SUBSCRIPTIONPAYMENT, StripePayActivity.this, false);
    ...
    public class SubscriptionTask extends AsyncTask<String, String, Charge> {
        ...
        protected Charge doInBackground(String... strings) {
            ...
            params.put("amount", price.substring(0, price.indexOf(".")));
