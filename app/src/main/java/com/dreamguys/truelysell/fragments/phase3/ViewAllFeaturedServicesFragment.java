...
//                getViewAllServices("Feature", "100000000", "1");
//            }
//        });

        rvViewallServices.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
                ...
                if (dy > 0) { //check for scroll down
                    ...
                    if (loading) {
                        if ((visibleItemCount + pastVisiblesItems) >= totalItemCount) {
                            ...
                            getViewAllServices("Feature", String.valueOf(listCount), String.valueOf(page));
...
//                            getViewAllServices("Feature");
    ...
    public void getViewAllServices(String type, String count, String page) {
...
//            ProgressDlg.showProgressDialog(getActivity(), null, null);
            ...
            try {
                ...
                Call<DAOViewAllServices> classificationCall = apiService.getViewAllServices(type, token, "11.0168445", "76.9558321", count, page);
