    ...
    public void getViewAllServices(String type) {
        if (AppUtils.isNetworkAvailable(getActivity())) {
            ...
            try {
                ...
                Call<DAOViewAllServices> classificationCall = apiService.getViewAllServices(type, token, PreferenceStorage.getKey(AppConstants.MY_LATITUDE), PreferenceStorage.getKey(AppConstants.MY_LONGITUDE), "10", "1");
