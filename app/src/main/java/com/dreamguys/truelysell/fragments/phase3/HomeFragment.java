...
//        if(PreferenceStorage.getKey(AppConstants.FIRSTENTRY) != null && PreferenceStorage.getKey(AppConstants.FIRSTENTRY).equals("true")) {
...
//                lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 30000, 0, (android.location.LocationListener) this);
...
//        }
        ...
        if (PreferenceStorage.getKey(AppConstants.USER_TOKEN) != null) {
            ...
            iv_userMapJobs.setVisibility(View.GONE);
        }
...
//                i.putExtra("From", AppConstants.PAGE_HOMEUSER);
//                startActivityForResult(i, 122);
//
////                Intent callMapActivity = new Intent(HomeActivity.this, MapActivity.class);
////                callMapActivity.putExtra("From", AppConstants.PAGE_HOMEUSER);
////                AppUtils.appStartIntent(this, callMapActivity);
//
//            } else {
//                PreferenceStorage.setKey(AppConstants.MY_LATITUDE, "19.0760");
//                PreferenceStorage.setKey(AppConstants.MY_LONGITUDE, "72.8777°");
//                PreferenceStorage.setKey(AppConstants.MY_ADDRESS, "");
//                PreferenceStorage.setKey(AppConstants.MY_CITYLOCATION, "Mumbai Suburban");
//            }
//
//        } else {
//
//        }
    ...
    private void getDateandtime() {
        if (AppUtils.isNetworkAvailable(getActivity())) {
            ...
            try {
                Call<GETDateandTime> classificationCall = apiService.getDateandtime();
                RetrofitHandler.executeRetrofit(getActivity(), classificationCall, AppConstants.GETDATETIME,
                        this, false);
            } catch (Exception e) {
...
//                getCategoryList();
            ...
            case R.id.tv_viewall_new:
                ...
                callViewAllServicesAct1.putExtra(AppConstants.VIEWALLTYPE, "3");
                startActivity(callViewAllServicesAct1);
                break;
            case R.id.tv_viewall_top_rated:
                Intent callViewAllServicesAct2 = new Intent(getActivity(), ViewAllServicesActivity.class);
                callViewAllServicesAct2.putExtra(AppConstants.VIEWALLTYPE, "2");
                startActivity(callViewAllServicesAct2);
                break;
            case R.id.iv_usermapjobs:
                Intent callMapjobs = new Intent(getActivity(), GetAJobMapViewActivity.class);
                startActivity(callMapjobs);
                break;
        }
    }
...
//                  Call<GETHomeList> classificationCall = apiService.getHomeList(token, "11.0168445", "76.9558321");
                ...
                //home list playstore
//                Call<GETHomeList> classificationCall = apiService.getHomeList(token);
//                RetrofitHandler.executeRetrofit(getActivity(), classificationCall, AppConstants.HOMELIST, this, false);
                ...
                if (getHomeList.getData() != null) {
                    ...
                    if (getHomeList.getData().getServiceList() != null) {
                        if (getHomeList.getData().getServiceList().size() > 0) {
                            ...
                            linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
                            homePopularServicesAdapter = new HomePopularServicesAdapter(getContext(),
                                    getHomeList.getData().getServiceList(), HomeFragment.this);
                    ...
                    if (getHomeList.getData().getNew_services() != null) {
                        if (getHomeList.getData().getNew_services().size() > 0) {
                            ...
                            linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
                            homeNewServicesAdapter = new HomeNewServicesAdapter(getContext(),
                                    getHomeList.getData().getNew_services(), HomeFragment.this);
                    ...
                    if (getHomeList.getData().getTop_RatedServices() != null) {
                        if (getHomeList.getData().getTop_RatedServices().size() > 0) {
                            rvTopRatedServices.setVisibility(View.VISIBLE);
                            tvNoNewServices.setVisibility(View.GONE);
                            linearLayoutManager = new LinearLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
                            homeTopRatedServicesAdapter = new HomeTopRatedServicesAdapter(getContext(),
                                    getHomeList.getData().getTop_RatedServices(), HomeFragment.this);
                            rvTopRatedServices.setLayoutManager(linearLayoutManager);
                            rvTopRatedServices.setAdapter(homeTopRatedServicesAdapter);
                        } else {
                            rvTopRatedServices.setVisibility(View.GONE);
                            tvNoNewServices.setVisibility(View.VISIBLE);
                        }
                    } else {
                        rvTopRatedServices.setVisibility(View.GONE);
...
//                }
            ...
            case AppConstants.FAVORITE:
                ...
                Toast.makeText(getActivity(), res.getResponseHeader().getResponseMessage(), Toast.LENGTH_SHORT).show();
                getHomeList();
                break;

            case AppConstants.GETDATETIME:

                GETDateandTime GETDateandTime1 = (GETDateandTime) myRes;

                if (GETDateandTime1.getData() != null) {

                    Date date = new Date();
                    String date2 = date.toString();

                    PreferenceStorage.setKey(AppConstants.DATEFORMAT, GETDateandTime1.getData().getDateFormat());

                    PreferenceStorage.setKey(AppConstants.TIMEFORMAT, GETDateandTime1.getData().getTimeFormat());

                    SimpleDateFormat formatter5 = new SimpleDateFormat(GETDateandTime1.getData().getDateFormat());
                    String formats1 = formatter5.format(date);

//                    Toast.makeText(getActivity(), formats1.toString(), Toast.LENGTH_SHORT).show();

//                    DateFormat dateFormat = android.text.format.DateFormat.getDateFormat(getActivity());
//                    mTimeText.setText("Time: " + dateFormat.format(dateStr));



                } else {
                    PreferenceStorage.setKey(AppConstants.DATEFORMAT, "MM-yyyy-dd");
//                    Toast.makeText(getActivity(), GETDateandTime1.getData().getDateFormat().toString(), Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
        ...
        Usergrprg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == Userrdbtn.getId()) {
                    ...
                    Toast.makeText(getActivity(), "Prov", Toast.LENGTH_SHORT).show();
                    selevctedtyprlog = "1";
                }
...
//                showMobileOTPDialog();
               ...
               PreferenceStorage.setKey(AppConstants.LOGINTYPESTR, "mobile");
...
//    }
    ...
    public void showCountrycodeDialog() {
        ...
        searchView = (SearchView) mShowAddProjectView.findViewById(R.id.searchview);
        TextView tvStatusType = mShowAddProjectView.findViewById(R.id.tv_statustype);
        tvStatusType.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(getActivity())));
        tvStatusType.setText(AppUtils.cleanLangStr(getActivity(),
                registerScreenList.getLblSelectCountry().getName(),
                R.string.txt_choose_country_code));
...
//            postGenerateOtp.put("email", email);
//            if (serviceCategoriesAdapter != null && serviceSubCategoriesAdapter != null) {
//                postGenerateOtp.put("category", "");
//                postGenerateOtp.put("subcategory", "");
//            }
//            postGenerateOtp.put("device_type", AppConstants.deviceType);
//            if (PreferenceStorage.getKey(AppConstants.refreshedToken) != null) {
//                postGenerateOtp.put("device_id", PreferenceStorage.getKey(AppConstants.refreshedToken));
    ...
    public void callFav(String serviceId, String type) {
        if (AppUtils.isNetworkAvailable(getActivity())) {
            ...
            try {
                ...
                RetrofitHandler.executeRetrofit(getActivity(), classificationCall, AppConstants.FAVORITE,
                        this, false);
            } catch (Exception e) {
                ProgressDlg.dismissProgressDialog();
                e.printStackTrace();
