...
public class SearchServicesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Activity mActivity;
    Context mContext;
    public List<DAOSearchServices.Data.Service> itemsData = new ArrayList<>();
    int viewType;
    ...
    public SearchServicesAdapter(Context mContext, List<DAOSearchServices.Data.Service> data,
                                 LanguageResponse.Data.Language.HomeScreen homeStringsList) {
