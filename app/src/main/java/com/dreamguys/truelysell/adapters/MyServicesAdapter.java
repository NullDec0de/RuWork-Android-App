...
public class MyServicesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    List<DAOMyServices.Data.Service> daoMyServices;
    ...
    public MyServicesAdapter(Context mContext, List<DAOMyServices.Data.Service> daoMyServices,
                             ServiceActiveInActiveFragment myProviderServicesActivity,
                             LanguageResponse.Data.Language.BookingService bookingServiceScreenList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (AppUtils.isThemeChanged(mContext)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                myServicesViewHolder.ivEdit.setImageTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(mContext)));
                myServicesViewHolder.ivDelete.setImageTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(mContext)));
            }
        }
        ...
        // Toast.makeText(mContext,""+(Float.parseFloat(daoMyServices.get(position).getRatings())+""+daoMyServices.get(position).getRatingCount()),Toast.LENGTH_SHORT).show();
        ...
        //  Toast.makeText(mContext,""+daoMyServices.get(position).getAdmin_verification(),Toast.LENGTH_SHORT).show();
        ...
        if (daoMyServices.get(position).getIsActive().equalsIgnoreCase("1")) {
            ...
            if (daoMyServices.get(position).getAdminVerification()==null||daoMyServices.get(position).getAdminVerification().equalsIgnoreCase("0")) {
        ...
        myServicesViewHolder.ivDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage(AppUtils.cleanLangStr(mContext, bookingServiceScreenList.getLbl_delete_title().getName(), R.string.txt_delete_service))
                        .setCancelable(false)
