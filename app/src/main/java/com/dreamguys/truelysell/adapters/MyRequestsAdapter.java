...
public class MyRequestsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Activity mActivity;
    Context mContext;
    public List<DAOMyRequests.Data.Liest> itemsData = new ArrayList<>();
    MyBookingRequestsActivity myBookingRequestsActivity;

    public MyRequestsAdapter(Context mContext, MyBookingRequestsActivity myBookingRequestsActivity, List<DAOMyRequests.Data.Liest> data) {
