...
public class BookingServicesAdapter extends PaginatedAdapter<DAOBookingList, RecyclerView.ViewHolder> {
    ...
    Activity mActivity;
    Context mContext;
    public List<DAOBookingList.Data.Booking> itemsData = new ArrayList<>();
    LanguageResponse.Data.Language.BookingService name;


    public BookingServicesAdapter(Context mContext, List<DAOBookingList.Data.Booking> data, LanguageResponse.Data.Language.BookingService name) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (!itemsData.get(position).getRating().isEmpty()) {
            ...
            bookingViewHolder.tvRating.setText("(" + itemsData.get(position).getRatingCount() + ")");
        }
        ...
        if (itemsData.get(position).getStatus().equalsIgnoreCase("8")) {
            bookingViewHolder.tvProgress.setText(AppUtils.cleanLangStr(mContext,
...
//            bookingViewHolder.tvProgress.setText(AppUtils.cleanLangStr(mContext,
//                    name.getLblPending().getName(), R.string.txt_pending));
            if(itemsData.get(position).getCod().equals("1")){
        ...
        Glide.with(mContext)
                ...
                .apply(new RequestOptions().placeholder(R.drawable.usericnew).transforms(new CenterCrop(), new RoundedCorners(40)))
