...
public class ViewAllPopularAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<DAOViewAllServices.ServiceList> list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        ((SearchServiceViewHolder) viewHolder).tvViewonmap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (itemsData.get(position).getService_latitude()!="" &&
                        itemsData.get(position).getService_longitude()!="") {
                    ...
                    AppUtils.showToast(mContext,"No Latitude,Longitude");
                }
