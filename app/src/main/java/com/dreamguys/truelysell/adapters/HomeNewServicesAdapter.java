...
//        endPoint.setLatitude(Double.parseDouble(new_services.get(position).getServiceLatitude()));
//        endPoint.setLongitude(Double.parseDouble(new_services.get(position).getServiceLongitude()));
//
