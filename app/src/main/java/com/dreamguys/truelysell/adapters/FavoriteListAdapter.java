...
public class FavoriteListAdapter extends RecyclerView.Adapter<FavoriteListAdapter.ViewHolder> {
    ...
    public List<FavoriteListResponse.Data.Userfavorite> items = new ArrayList<>();
...
//        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_favorites, parent, false);
        ...
        if (viewType == LOADING) {
            v = LayoutInflater.from(context).inflate(R.layout.layout_loading_item, parent, false);
            return new ViewHolder(v);
        } else {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_favorites, parent, false);
            return new ViewHolder(v);
        }
    ...
    public void updateRecyclerView(Context context, List<FavoriteListResponse.Data.Userfavorite> items) {
        this.context = context;
