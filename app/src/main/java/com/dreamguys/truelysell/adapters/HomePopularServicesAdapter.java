...
//        if(serviceList.get(position).getServiceLatitude()!=null||!serviceList.get(position).getServiceLatitude().equals("")){
//
//            Location endPoint = new Location("locationB");
//            endPoint.setLatitude(Double.parseDouble(serviceList.get(position).getServiceLatitude()));
//            endPoint.setLongitude(Double.parseDouble(serviceList.get(position).getServiceLongitude()));
//
...
//
//
//            popularViewHolder.Tv_lovtxt.setText(val + " km");
//
//        } else {
//            popularViewHolder.Tv_lovtxt.setText(" km");
//        }
        ...
        Glide.with(mContext)
                ...
                .apply(new RequestOptions().error(R.drawable.ic_service_placeholder).placeholder(R.drawable.ic_service_placeholder).transforms(new CenterCrop(), new RoundedCorners(20)))
        ...
        Glide.with(mContext)
                ...
                .apply(new RequestOptions().error(R.drawable.usericnew).placeholder(R.drawable.usericnew).transforms(new CenterCrop(), new RoundedCorners(20)))
                .into(popularViewHolder.ivProfileImage);

        if (serviceList.get(position).getService_favorite() != null) {
            if (serviceList.get(position).getService_favorite().equalsIgnoreCase("1")) {
                popularViewHolder.icFav.setLiked(true);
            } else {
                popularViewHolder.icFav.setLiked(false);
            }
        }
        ...
        popularViewHolder.icFav.setOnLikeListener(new OnLikeListener() {
            ...
            public void liked(LikeButton likeButton) {
                homeFragment.callFav(serviceList.get(position).getServiceId(), "1");
            }

            @Override
            public void unLiked(LikeButton likeButton) {
                homeFragment.callFav(serviceList.get(position).getServiceId(), "0");
            }
        });
    }
