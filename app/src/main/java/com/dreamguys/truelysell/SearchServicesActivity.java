    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_Mapactivity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent callMapActivity = new Intent(SearchServicesActivity.this, GetAJobMapViewActivity.class);
                    callMapActivity.putExtra("page", "search");
                    callMapActivity.putExtra("type", "none");
                    callMapActivity.putExtra("value", value);
        ...
        switch (responseType) {
            case AppConstants.SEARCHSERVICES:
                ...
                if (daoSearchServices.getData() != null && daoSearchServices.getData().getServiceList().size() > 0) {
                    ...
                    rvSearchServices.setAdapter(new SearchServicesAdapter(this, daoSearchServices.getData().getServiceList(), homeStringsList));
                } else {
