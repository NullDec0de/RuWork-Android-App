...
public class GETHomeList extends BaseResponse {
    ...
    public class Data {
        ...
        @SerializedName("top_rating_services")
        @Expose
        private List<TopRatedService> topratedservices = null;
        ...
        public List<TopRatedService> getTop_RatedServices() {
            return topratedservices;
        }

        public void setTop_RatedServices(List<TopRatedService> topratedservices) {
            this.topratedservices = topratedservices;
        }
    ...
    public class ServiceList {
        ...
        @Expose
        private String service_favorite;

        public String getService_favorite() {
            return service_favorite;
        }

        public void setService_favorite(String service_favorite) {
            this.service_favorite = service_favorite;
        }
