...
public class    HomeActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
        GoogleApiClient.ConnectionCallbacks, LocationListener, RetrofitHandler.RetrofitResHandler , CountryCodePicker.OnCountryChangeListener {
    ...
    TextView Tv_forgotPassword, Tvprivacyaccept;

    Button btnGetStarted, btnBack, btnContinue, btnRegisterBack, btnLogin;
    ...
    RadioButton Userrdbtn, Providerrdbtn;
...
//        });
    ...
    private void checkBlock() {
        if (AppUtils.isNetworkAvailable(HomeActivity.this)) {
            ...
            try {
                ...
                Call<CheckBlockResponse> classificationCall = apiService.checkBlock(token);
                RetrofitHandler.executeRetrofit(HomeActivity.this, classificationCall,
                        AppConstants.CHECKBLOCK,
                        this, false);
            } catch (Exception e) {
                ProgressDlg.dismissProgressDialog();
                e.printStackTrace();
    ...
    public void showUserLoginDialog() {
        ...
        Usergrprg = view.findViewById(R.id.usergrprg);
        Userrdbtn = view.findViewById(R.id.userrdbtn);
        Providerrdbtn = view.findViewById(R.id.providerrdbtn);




        ccp = view.findViewById(R.id.cccp);
        ...
        Tv_forgotPassword = view.findViewById(R.id.tvatc);
        Tvprivacyaccept = view.findViewById(R.id.tvprivacyaccept);

        Agretccchk = view.findViewById(R.id.agretccchk);

        if (AppUtils.isThemeChanged(HomeActivity.this)) {
            btnBack.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            btnContinue.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            btnGetStarted.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            btnLogin.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            btnRegister.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            btnRegisterBack.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            btnVerify.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            ivExitDialog.setBackgroundTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
            cbExistingUser.setButtonTintList(ColorStateList.valueOf(AppUtils.getPrimaryAppTheme(HomeActivity.this)));
        }
        ...
        Tv_forgotPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra(AppConstants.TbTitle, AppUtils.cleanLangStr(HomeActivity.this,
                        "Terms and Conditions", R.string.terms_and_conditions));
        ...
        Tvprivacyaccept.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent i = new Intent(HomeActivity.this, WebViewActivity.class);
                i.putExtra(AppConstants.TbTitle, AppUtils.cleanLangStr(HomeActivity.this,
                        "Privacy Policy", R.string.privacyPolicyy));
                i.putExtra(AppConstants.URL, AppConstants.PrivacyPolicyURL);
                startActivity(i);
        ...
        try {
            tvProfessional.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    "Create an Account", R.string.txt_join_as_professional));
            serviceProvide.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLblServiceYouProvide().getName(), R.string.txt_what_service_do_you_provide));
            tvCatetory.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLblSelectServiceHere().getName(), R.string.txt_select_your_service_here));
            btnLogin.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLblLogin().getName(), R.string.txt_login));
            btnGetStarted.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLblGetStarted().getName(), R.string.txt_get_started));
            txtSubCategory.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLblChooseSubcategory().getName(), R.string.txt_choose_sub_category));
            tvSubCatetory.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLblSelectSubcategory().getName(), R.string.txt_select_your_subcategory));
            btnBack.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getBtnPrevious().getName(), R.string.txt_previous));
            btnContinue.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getBtnNext().getName(), R.string.txt_next));
            etName.setHint(AppUtils.cleanLangStr(HomeActivity.this,
            ...
            etCountryCode.setHint(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getBtnCode().getPlaceholder(), R.string.txt_code));
            etMobileNumber.setHint(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getTxtFldMobileNum().getPlaceholder(), R.string.txt_mobile_number));
            et_refferalCode.setHint(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getTxtFldReferenceCode().getPlaceholder(), R.string.txt_refferal_code));
            cbExistingUser.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    "Already have an account", R.string.already_a_professional));
            btnRegisterBack.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getBtnPrevious().getName(), R.string.txt_previous));
            ...
            tvResendCode.setText(AppUtils.cleanLangStr(HomeActivity.this,
            ...
            tvDidntOtp.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLbl_dint_receive_otp().getName(), R.string.txt_didn_t_receive_otp));
            btnVerify.setText(AppUtils.cleanLangStr(HomeActivity.this,
                    registerScreenList.getLbl_verify().getName(), R.string.txt_verify));
            tv_forgotPassword.setText(AppUtils.cleanLangStr(HomeActivity.this,
        ...
        otpView.setOtpCompletionListener(new OnOtpCompletionListener() {
            ...
            public void onOtpCompleted(String otp) {
                ...
                if(selevctedtyprlog.equals("1")){
                    postProffessionalLogin(etMobileNumber.getText().toString(), ccp.getSelectedCountryCode().toString(),
                            otp, "", "");
                    Log.d("onOtpCompleted=>", otp);
                } else {
                    postUserLogin(etMobileNumber.getText().toString(), ccp.getSelectedCountryCode().toString(),
                            otp, "", "");
                    Log.d("onOtpCompleted=>", otp);
//                    postUserLogin(etMobileNumber.getText().toString(),
//                            ccp.getSelectedCountryCode().toString(), otpView.getText().toString(), "", "");
                }
        ...
        tvResendCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (PreferenceStorage.getKey(AppConstants.LOGINTYPESTR).equalsIgnoreCase("email")) {
                    ...
                    getMobileOtp(ccp.getSelectedCountryCode().toString().trim(), etMobileNumber.getText().toString().trim(), "", "", "", "");
                }
            }
        });


        Usergrprg.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == Userrdbtn.getId()) {
                    Toast.makeText(HomeActivity.this, "User", Toast.LENGTH_SHORT).show();
                    selevctedtyprlog = "2";
                } else if (checkedId == Providerrdbtn.getId()) {
                    Toast.makeText(HomeActivity.this, "Prov", Toast.LENGTH_SHORT).show();
                    selevctedtyprlog = "1";
                }
        ...
        btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (otpView.getText().toString().isEmpty() || otpView.getText().toString().length() < 4) {
                    ...
                    imm.hideSoftInputFromWindow(otpView.getWindowToken(), 0);
                    if(selevctedtyprlog.equals("1")){
                        postProffessionalLogin(etMobileNumber.getText().toString(), ccp.getSelectedCountryCode().toString(), otpView.getText().toString(),
                                "", "");
                    } else {
                        postUserLogin(etMobileNumber.getText().toString(),
                                ccp.getSelectedCountryCode().toString(), otpView.getText().toString(), "", "");
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    btnRegister.setText(AppUtils.cleanLangStr(HomeActivity.this,
                            registerScreenList.getLblLogin().getName(), R.string.txt_login));
                    tvProfessional.setText(AppUtils.cleanLangStr(HomeActivity.this,
                            "Already have an Account", R.string.login_as_professional));
                } else {
                    if (PreferenceStorage.getKey(AppConstants.LOGINTYPESTR) != null && PreferenceStorage.getKey(AppConstants.LOGINTYPESTR).equalsIgnoreCase("email")) {
                        ll_password.setVisibility(View.VISIBLE);
                        llEmail.setVisibility(View.VISIBLE);
...
//                } else {
//                    Toast.makeText(HomeActivity.this, daoServiceSubCategories.getResponseHeader().getResponseMessage(), Toast.LENGTH_SHORT).show();
//                }
            }
        });
...
//                            AppUtils.cleanLangStr(HomeActivity.this,
...
//                } else {
//                    Toast.makeText(HomeActivity.this, "Choose any one Subcategory", Toast.LENGTH_SHORT).show();
//                }
            }
        });
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    Toast.makeText(HomeActivity.this,
                            AppUtils.cleanLangStr(HomeActivity.this,
                                    "Agree to terms first", R.string.agree_to_terms_firsr), Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(selevctedtyprlog.equals("1")){
                    if (cbExistingUser.isChecked()) {
                        if (PreferenceStorage.getKey(AppConstants.LOGINTYPESTR).equalsIgnoreCase("email")) {
                            ...
                            if (ccp.getSelectedCountryCode().toString().isEmpty()) {
                                Toast.makeText(HomeActivity.this, AppUtils.cleanLangStr(HomeActivity.this,
                                ...
                                PreferenceStorage.setKey(AppConstants.EMAIL_ID, etEmailAddress.getText().toString());
                                getMobileOtp(ccp.getSelectedCountryCode().toString().trim(),
                        ...
                        if (etName.getText().toString().isEmpty()) {
                            ...
                            Toast.makeText(HomeActivity.this, AppUtils.cleanLangStr(HomeActivity.this,
                                    registerScreenList.getTxtFldEmail().getValidation2(), R.string.txt_enter_valid_email), Toast.LENGTH_SHORT).show();
                        } else if (ccp.getSelectedCountryCode().toString().toString().isEmpty()) {
                            Toast.makeText(HomeActivity.this, AppUtils.cleanLangStr(HomeActivity.this,
                                    registerScreenList.getBtnCode().getValidation1(), R.string.txt_select_country_code), Toast.LENGTH_SHORT).show();
                        } else if (etMobileNumber.getText().toString().isEmpty()) {
                            Toast.makeText(HomeActivity.this, AppUtils.cleanLangStr(HomeActivity.this,
                    ...
                    if (cbExistingUser.isChecked()) {
                        ...
                        } else if (ccp.getSelectedCountryCode().toString().isEmpty()) {
                            Toast.makeText(HomeActivity.this, AppUtils.cleanLangStr(HomeActivity.this,
                                    registerScreenList.getBtnCode().getValidation1(), R.string.txt_select_country_code), Toast.LENGTH_SHORT).show();
                        } else if (etMobileNumber.getText().toString().isEmpty()) {
                            Toast.makeText(HomeActivity.this, AppUtils.cleanLangStr(HomeActivity.this,
            ...
            case AppConstants.PROFESSIONALLOGIN:
                ...
                if(selevctedtyprlog.equals("1")){
                    if (daoLoginProfessional.getData().getProviderDetails() != null) {
                        Toast.makeText(HomeActivity.this, daoLoginProfessional.getResponseHeader().getResponseMessage(), Toast.LENGTH_SHORT).show();
...
//                }
            ...
            case AppConstants.FORGOTPASSWORD:
                ...
                break;
            case AppConstants.CHECKBLOCK:
                CheckBlockResponse checkBlockResponse = (CheckBlockResponse) myRes;
                if (checkBlockResponse.getData().getUserblock())
                    callClear();
                break;
        }
    }
        ...
        builder.setMessage("Account Blocked")
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        AppUtils.appStartIntent(HomeActivity.this, a);
                        finish();
                    }
                });
...
//            PreferenceStorage.setKey(AppConstants.MYNUMBER, mobile_no);


            if (selevctedtyprlog.equals("2")) {
        ...
        if (requestCode == 1) {
            switch (requestCode) {
                case 1:
                    ...
                    break;
                case 122:
                Fragment fragment = getSupportFragmentManager().findFragmentById(R.id.fragment_frame_layout);
...
//            ProgressDlg.showProgressDialog(HomeActivity.this, null, null);
    ...
    private void showForgotPasswordDialog() {
        ...
        tv_forgotPasswordTitle.setText(AppUtils.cleanLangStr(HomeActivity.this,
               "Forgot Password", R.string.txt_forgot_password));
