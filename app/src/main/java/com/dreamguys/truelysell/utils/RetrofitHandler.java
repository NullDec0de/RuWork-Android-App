            ...
            public void onResponse(Call<T> call, Response<T> response) {
                ...
                switch (responeModel) {
                    ...
                    case AppConstants.GETPAYPALTOKEN:
                        ...
                        break;
                    case AppConstants.SUBSCRIPTIONPAYMENT:
                        try {
                            SubscriptionPaymentResponse paymentResponse = (SubscriptionPaymentResponse) response.body();
                            mBaseResponse = paymentResponse.getResponseHeader();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                        break;
                    ...
                    case AppConstants.FAVORITELIST:
                        try {
                            FavoriteListResponse paymentResponse = (FavoriteListResponse) response.body();
                            mBaseResponse = paymentResponse.getResponseHeader();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    case AppConstants.CHECKBLOCK:
                        try {
                            CheckBlockResponse paymentResponse = (CheckBlockResponse) response.body();
                            mBaseResponse = paymentResponse.getResponseHeader();
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    ...
                    case AppConstants.BLOCKPROVIDER:
                        try {
