...
public class AppConstants {
    ...
    public static final String BASE_URL = "https://truelysell.com/"; // Testing team url

//    public static final String BASE_URL = "https://truelysell.dreamguystech.com/"; // Development url
//    public static final String BASE_URL = "https://truelysell.com/"; // Live url

    public static final String COUNTRYLISTURL = BASE_URL + "api/countries";
    public static final String WEBSOCKETURL = "wss://truelysell.com:8443";
    ...
    public static final String PAGE_HOMEUSER = "PAGE_HOMEUSER";
    public static final String GETDATETIME = "GETDATETIME";
    public static final String FIRSTENTRY = "false";
    ...
    public static final String PrivacyPolicyURL = BASE_URL + "/privacy/";
    ...
    public static final String LOGINTYPESTR = "mobile";
    public static final String FORGOTPASSWORD = "FORGOTPASSWORD";
    public static final String FAVORITE = "FAVORITE";
    public static final String FAVORITELIST = "FAVORITELIST";
    public static final String BLOCKPROVIDER = "BLOCKPROVIDER";
    public static final String CHECKBLOCK = "CHECKBLOCK";
    ...
    public static String stripe_account_email = "stripe_account_email";
    public static String stripe_account_phone = "stripe_account_phone";
