...
public class StripeSettingsActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (PreferenceStorage.getKey(AppConstants.stripe_Acc_name) != null) {
            ...
            et_Email.setText(PreferenceStorage.getKey(AppConstants.stripe_account_email));

            et_Contactno.setText(PreferenceStorage.getKey(AppConstants.stripe_account_phone));
        }
        setLanguageValues();
    }
    ...
    public void onViewClicked() {
        if (editAcc_Holder_name.getText().toString().isEmpty()) {
            ...
            AppUtils.showToast(this, AppUtils.cleanLangStr(this,
                    "Enter your email", R.string.err_email_address));
            et_Email.requestFocus();
        } else if (et_Contactno.getText().toString().isEmpty()) {
            AppUtils.showToast(this, AppUtils.cleanLangStr(this,
                    "Enter your mobile number", R.string.err_phone));
            ...
            postStripeRegisterData.put("email", et_Email.getText().toString());
            postStripeRegisterData.put("contact_number", et_Contactno.getText().toString());
            ...
            apiInterface.postRegisterStripeDetails(postStripeRegisterData,
                ...
                public void onResponse(Call<BaseResponse> call, Response<BaseResponse> response) {
                    ...
                    if (response.isSuccessful() &&
                        ...
                        PreferenceStorage.setKey(AppConstants.stripe_account_email, et_Email.getText().toString());
                        PreferenceStorage.setKey(AppConstants.stripe_account_phone, et_Contactno.getText().toString());
