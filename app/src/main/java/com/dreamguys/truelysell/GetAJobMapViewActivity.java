...
public class GetAJobMapViewActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public List<DAOSearchServices.Data.Service> itemsDatasearch = new ArrayList<>();
    ...
    public void getViewAllServices(String type) {
        if (AppUtils.isNetworkAvailable(GetAJobMapViewActivity.this)) {
            ...
            try {
                ...
                Call<DAOViewAllServices> classificationCall = apiService.getViewAllServices(type, token, PreferenceStorage.getKey(AppConstants.MY_LATITUDE), PreferenceStorage.getKey(AppConstants.MY_LONGITUDE), "100000", "1");
        ...
        switch (responseType) {
            ...
            case AppConstants.SEARCHSERVICES:
                ...
                if (daoSearchServices.getData() != null) {
                    itemsDatasearch.addAll(daoSearchServices.getData().getServiceList());
