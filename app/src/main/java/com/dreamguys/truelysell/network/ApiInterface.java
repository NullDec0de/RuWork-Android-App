...
public interface ApiInterface {
    ...
    Call<POSTCreategigs> paymentSuccess(@Path("orderid") String orderid, @Path("refid") String refid, @Header("token") String token, @Header("language") String Language);

    //Phase 3


//    @FormUrlEncoded
//    @POST("api/api/demo_home") //play store
////    @POST("api/home")
//        //codecanyon
//    Call<GETHomeList> getHomeList(@Header("token") String token);

    @FormUrlEncoded
//     @POST("api/api/demo-home") //play store
    @POST("api/home")
        //codecanyon
...
//    Call<JSONArray> getCountryCode();
    ...
    Call<WalletDetailResponse> getViewWalletHistory(@Header("token") String token, @Field("wallet_txn_id") String id);
    ...
    Call<DAOMyServices> getMyServices(@Header("token") String token, @Field("type") String type, @Field("counts_per_page") String count, @Field("current_page") String page );
    ...
    Call<DAOViewAllServices> getViewAllServices(@Field("type") String type, @Header("token") String token, @Field("latitude") String latitude, @Field("longitude") String longitude, @Field("counts_per_page") String count, @Field("current_page") String page );
    ...
    Call<POSTCurrencyConversion> postCurrencyconversion(@FieldMap Map<String, String> params, @Header("token") String token);
    ...
    Call<DAOBookingList> bookingList(@Header("token") String token, @Field("type") String type, @Field("status") String status, @Field("counts_per_page") String count, @Field("current_page") String page );


    @FormUrlEncoded
    @POST("api/api/bookinglist")
    Call<DAOBookingList> bookingListwithpag(@Header("token") String token, @Field("type") String type, @Field("status") String status, @Field("counts_per_page") String count, @Field("current_page") String page );
    ...
    @FormUrlEncoded
    @POST("api/api/wallet_withdraw")
    Call<BaseResponse> walletWithdrawPaypl(@Header("token") String token,
                                      @Field("amount") String amount,
    ...
    Call<SubscriptionPaymentResponse> subscriptionPayment(@Header("token") String token,
                                                          @Field("tokenid") String tokenid,
                                                          @Field("amount") String amount,
                                                          @Field("subscription_id") String subscription_id,
                                                          @Field("description") String confirm_password);

    @FormUrlEncoded
    @POST("api/api/service_favorite_status")
    Call<EmptyData> callFavorite(@Header("token") String token, @Field("service_id") String serviceId,
                                 @Field("status") String status);


    @GET("api/api/userfavorites")
    Call<FavoriteListResponse> getFavoriteList(@Header("token") String token);

    @GET("api/api/userfavorites")
    Call<FavoriteListResponse> getFavoriteListpag(@Header("token") String token,@Query("counts_per_page") String count, @Query("current_page") String page);

    @FormUrlEncoded
    @POST("api/api/block_providers")
    Call<EmptyData> blockProvider(@Header("token") String token,
                                  @Field("provider_id") String provideId,
                                  @Field("reason") String reason);

    @FormUrlEncoded
    @POST("api/api/block_users")
    Call<EmptyData> blockUser(@Header("token") String token,
                              @Field("user_id") String userId,
                              @Field("reason") String reason);

    @GET("api/api/check_user_block")
    Call<CheckBlockResponse> checkBlock(@Header("token") String token);
